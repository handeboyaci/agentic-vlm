...
def main():
  ...
  parser.add_argument("--diseases", type=str, default="Alzheimer's,Cancer,COVID-19", help="Comma-separated diseases")
  parser.add_argument("--reset", action="store_true", help="Reset version store before adding")
